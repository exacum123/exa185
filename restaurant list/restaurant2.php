...
<section class="container">
  ...
  echo "<h6>" . "Intro: " . $jsondata['restaurant'][2]["intro"] . "</h6>" . "<br>" . "<br>" . "<br>";
  ?>
</section>
...
<div class="container justify-content-start">
  <div class="row">
    ...
    <div class="col-7 offset-2">
      ...
      echo "No.1" . "<p>" . $jsondata['restaurant'][2]["food"][0]['id0'] . "</p>" . "<br>" . "<br>" . "<br>";
      echo '<img src="../img/dish2.jfif">'."<br>";
      echo "No.2" . "<p>" . $jsondata['restaurant'][2]["food"][0]['id1'] . "</p>" . "<br>" . "<br>" . "<br>";
      echo '<img src="../img/dish3.jfif">'."<br>";
      echo "No.3" . "<p>" . $jsondata['restaurant'][2]["food"][0]['id2'] . "</p>" . "<br>" . "<br>" . "<br>";
      echo '<img src="../img/dish4.jfif">'."<br>";
      echo "No.4" . "<p>" . $jsondata['restaurant'][2]["food"][0]['id3'] . "</p>" . "<br>" . "<br>" . "<br>";
      echo '<img src="../img/dish5.jfif">'."<br>";
      echo "No.5" . "<p>" . $jsondata['restaurant'][2]["food"][0]['id4'] . "</p>" . "<br>" . "<br>" . "<br>";
      echo '<img src="../img/dish6.jfif">'."<br>";
      echo "No.6" . "<p>" . $jsondata['restaurant'][2]["food"][0]['id5'] . "</p>" . "<br>" . "<br>" . "<br>";
      ?>
    </div>
  </div>
</div>
