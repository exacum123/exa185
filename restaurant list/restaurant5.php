    ...
    <div class="col-3">
      ...
      <div class="card mt-3 mb-5" style="width: 19rem;">
        <ul class="list-group list-group-flush">
          <li class="list-group-item" id="barColor"><?php echo "Tel: " . $jsondata['restaurant'][5]["tel"]; ?></li>
          <li class="list-group-item" id="barColor"><?php echo "Address: " . $jsondata['restaurant'][5]["adrs"]; ?></li>
        </ul>
      </div>
      <?php echo "Opening Hours: " . "<br>" . "<br>"; ?>
      <div class="card mt-1 d-flex justify-content-start" style="width: 19rem;">
        <ul class="list-group list-group-flush">
          <li class="list-group-item" id="barColor"><?php echo "<h4>" . "Mon-Fri:" . $jsondata['restaurant'][5]['time'][0]['MonFri'] . "</h4>"; ?></li>
          <li class="list-group-item" id="barColor"><?php echo "<h4>" . "Sat-Sun:" . $jsondata['restaurant'][5]['time'][0]['SatSun'] . "</h4>"; ?></li>
        </ul>
      </div>
    </div>
