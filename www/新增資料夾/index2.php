...
<?php    
    echo $jsondata['restaurant'][0]["name"]."<br>";
    echo $jsondata['restaurant'][0]["tel"]."<br>";
    echo $jsondata['restaurant'][0]["adrs"]."<br>";
    echo $jsondata['restaurant'][0]['time'][0]['MonFri']."<br>";
    echo $jsondata['restaurant'][0]['time'][0]['SatSun']."<br>";
?>
