...
<div class="container justify-content-start">
  <div class="row">
    <div class="col-3">
      <?php
      echo "Tel: " . $jsondata['restaurant'][1]["tel"] . "<br>";
      echo "Address: " . $jsondata['restaurant'][1]["adrs"] . "<br>" . "<br>" . "<br>" . "<br>";
      echo "Opening Hours: " . "<br>" . "<br>"  ;
      echo "<h5>" . "Mon-Fri:" . $jsondata['restaurant'][1]['time'][0]['MonFri'] . "</h5>";
      echo "<h5>" . "Sat-Sun:" . $jsondata['restaurant'][1]['time'][0]['SatSun'] . "</h5>" . "<br>" . "<br>";
      ?>    
    </div>  
